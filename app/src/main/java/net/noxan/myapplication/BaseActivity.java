...
public class BaseActivity extends AppCompatActivity
    ...
    public void onPostCreate(Bundle savedInstanceState) {
        ...
        // FIXME: does not work
        View navItem = findViewById(getActiveNavigationItem());
        if(navItem != null) {
            MenuItem navMenuItem = (MenuItem) navItem;
    ...
    private void changeActivity(final Class activity) {
        View mainContent = findViewById(R.id.main_content);
        if (mainContent != null) {
            mainContent.animate().alpha(0).setDuration(150);
        }

        final BaseActivity base = this;

        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(base, activity));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (getActiveNavigationItem() == id) {
            // avoid to reopen the current item
